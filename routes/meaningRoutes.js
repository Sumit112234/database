...
// Fetch previous and next meanings based on ID
// router.get('/:id', async (req, res) => {
//     const { id } = req.params;
//     const meanings = await Meaning.find();
//     const index = meanings.findIndex(m => m._id.toString() === id);

//     res.json({
//         previous: meanings[index - 1] || null,
//         current: meanings[index],
//         next: meanings[index + 1] || null,
//     });
// });
